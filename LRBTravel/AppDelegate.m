...
- (void)applicationWillResignActive:(UIApplication *)application {
     ...
     [[LRBUserInfo shareUserInfo] saveUserInfo];
...
//    [[LRBUserInfo shareUserInfo] readUserInfo];
}
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"LRBTravel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"LRBTravel.sqlite"];
...
{
    [[UINavigationBar appearance] setBarTintColor:UIColorFromRGB(0x009EE5)];
